        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-4xl lg:text-5xl font-bold text-black leading-tight">
              Intelligent Systems for Connected Industrial Operations
            </h1>
            <p className="text-sm text-black font-semibold leading-relaxed max-w-lg">
              Industrial operations depend on tightly controlled systems to
              maintain efficiency, safety, and reliability. We help
              organizations engineer them to operate intelligently at scale.
            </p>
            <Link
