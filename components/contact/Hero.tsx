export default function ContactHero() {
  return (
    <section className="relative py-8 bg-linear-to-r from-gray-700 to-gray-800 overflow-hidden">
      {/* Dotted pattern overlay */}
      <div
        className="absolute inset-0 opacity-20 bg-[radial-gradient(circle,rgba(255,255,255,0.3)_1px,transparent_1px)] bg-size[20px_20px]"
      />
